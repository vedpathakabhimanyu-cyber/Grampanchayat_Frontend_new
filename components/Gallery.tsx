...
const Gallery = () => {
  ...
  return (
    <section className="my-12 sm:my-16 px-4 sm:px-8 md:px-16 lg:px-20 ">
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#0A1931]/95 to-[#1a2c55]/95 text-white px-6 py-3 flex items-center justify-start space-x-3 rounded-t-2xl shadow-md backdrop-blur-md">
          <FaImages className="text-lg sm:text-xl md:text-2xl text-white" />
          <h2 className="text-lg sm:text-xl md:text-2xl font-semibold tracking-wide uppercase">
            फोटो गॅलरी
          </h2>
        </div>

        {/* Gallery Grid */}
        <div className="p-5 sm:p-8 md:p-10 bg-transparent">
          {loading ? (
              ...
              {images.map((image) => (
                ...
                >
                  ...
                  <div className="p-3 sm:p-4">
                    <h3 className="font-bold text-government-blue mb-1 line-clamp-1 text-base md:text-lg lg:text-xl">
                      {image.title || "फोटो"}
                    </h3>
                    {image.createdAt && (
          ...
          <div className="mt-10 text-center">
            <Link href="/gallery">
              <button className="nline-block bg-[#0A1931] hover:bg-[#142b4a] text-white font-medium text-base md:text-lg px-5 py-2 rounded-lg transition-colors duration-200">
                संपूर्ण गॅलरी पहा
              </button>
            </Link>
          </div>
